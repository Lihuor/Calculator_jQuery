$(document).ready(function () {
    ...
    // Creating our variables global to the runtime of our application
    var firstNumber = 0;
    var secondNumber = 0;
    var operator = "";
    var result = 0;
    ...
    // Creating the button click function 
    $(".number").click(function () { 
        ...
        // If operator is chose, we should be writing the secondNumber, otherwise, the firstNumber
        if (isOperatorChosen) {
    ...
    // Creating the Equal Click Button
    $(".equal").click(function(){
        // if we are already clicked equal, don't do the calculation again
        if (isCalculated) {
            return false;
        }
